...
var fs = require('fs-extra'),
    ...
    nativeDocumentScreenshot = require('./nativeDocumentScreenshot.js'),
...
var WebdriverCSS = function(webdriverInstance, options) {
    ...
    this.nativeDocumentScreenshot = options.nativeDocumentScreenshot || false;
    this.preScreenshot = options.preScreenshot || null;
    this.warning = [];
    this.resultObject = {};
    ...
    */
    ...
    this.instance.addCommand('saveNativeDocumentScreenshot', nativeDocumentScreenshot.bind(this));
