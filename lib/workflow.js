...
module.exports = function(pagename, args) {
    ...
    var context = {
        ...
        nativeDocumentScreenshot: this.nativeDocumentScreenshot,
        preScreenshot:            this.preScreenshot,
    ...
    async.waterfall([
        ...
        /**
         * execute optional pre-screenshot script
         */
        require('./preScreenshot.js').bind(context),
